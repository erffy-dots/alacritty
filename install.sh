...
readonly REPO_URL="https://github.com/erffy-dots/alacritty.git"
...
echo "Downloading Alacritty configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Alacritty configuration detected at '$CONFIG_DIR'."
...
echo "You may need to install additional dependencies for Alacritty."
echo "Refer to the Alacritty documentation for more information."
